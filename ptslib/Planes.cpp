...
PTEXPORT void SetPlaneConstants(float minDist, float splitThreshold, float
...
PTEXPORT void DepthMakePlanes(float* vals, Pt* outVertices, Pt* outTexCoords, int maxCount, int* outCount,
