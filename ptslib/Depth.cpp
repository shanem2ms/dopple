...
PTEXPORT void DepthFindNormals(float* vals, float* outpts, int px, int py, int depthWidth, int depthHeight)
{
...
PTEXPORT void DepthInvFillNAN(float* dbuf, float* outpts, int depthWidth, int depthHeight)
{
...
PTEXPORT void DepthBlur(float* dbuf, float* outpts, int depthWidth, int depthHeight, int blur)
{
...
PTEXPORT float DepthEdge(float* dbuf, float* outpts, int depthWidth, int depthHeight, int blur, int maxPts)
{
...
PTEXPORT void ImageBlur(unsigned char* ibuf, unsigned char* outpts, int imageWidth, int imageHeight, int blur)
{
    std::vector<float> dinv;
...
PTEXPORT void DepthBuildLods(float* dbuf, float* outpts, int depthWidth, int depthHeight, float maxdist)
{
    std::vector<float> dinv;
    dinv.reserve(depthWidth * depthHeight);
    float* dend = dbuf + (depthWidth * depthHeight);
