...
public partial class alg
{
    ...
    *************************************************************************/
    ...
    public static void odesolverrkck(double[] y, int n, double[] x, int m, double eps, double h, out odesolverstate state, alg.xparams _params)
    {
        state = new odesolverstate();
    ...
    public static void odesolverrkck(double[] y, double[] x, double eps, double h, out odesolverstate state, alg.xparams _params)
    {
        int n;
        int m;
    ...
    *************************************************************************/
    ...
    public static bool odesolveriteration(odesolverstate state, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void odesolversolve(odesolverstate state, ndimensional_ode_rp diff, object obj, alg.xparams _params)
    {
        if( diff==null )
            throw new alglibexception("ALGLIB: error in 'odesolversolve()' (diff is null)");
        while( alg.odesolveriteration(state, _params) )
        {
            if( state.needdy )
            {
    ...
    *************************************************************************/
    ...
    public static void odesolverresults(odesolverstate state, out int m, out double[] xtbl, out double[,] ytbl, out odesolverreport rep, alg.xparams _params)
    {
        m = 0;
        xtbl = new double[0];
        ytbl = new double[0,0];
    ...
    public class odesolver
    {
        ...
        *************************************************************************/
        public static void odesolverrkck(double[] y,
            ...
            alg.xparams _params)
        {
            alg.ap.assert(n>=1, "ODESolverRKCK: N<1!");
            alg.ap.assert(m>=1, "ODESolverRKCK: M<1!");
            alg.ap.assert(alg.ap.len(y)>=n, "ODESolverRKCK: Length(Y)<N!");
            alg.ap.assert(alg.ap.len(x)>=m, "ODESolverRKCK: Length(X)<M!");
            alg.ap.assert(apserv.isfinitevector(y, n, _params), "ODESolverRKCK: Y contains infinite or NaN values!");
            alg.ap.assert(apserv.isfinitevector(x, m, _params), "ODESolverRKCK: Y contains infinite or NaN values!");
            alg.ap.assert(math.isfinite(eps), "ODESolverRKCK: Eps is not finite!");
            alg.ap.assert((double)(eps)!=(double)(0), "ODESolverRKCK: Eps is zero!");
            alg.ap.assert(math.isfinite(h), "ODESolverRKCK: H is not finite!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            //
            alg.ap.assert((double)(state.h)>(double)(0), "ODESolver: internal error");
            alg.ap.assert(m>1, "ODESolverIteration: internal error");
