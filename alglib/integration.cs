...
public partial class alg
{
    ...
    *************************************************************************/
    ...
    public static void gqgeneraterec(double[] alpha, double[] beta, double mu0, int n, out int info, out double[] x, out double[] w, alg.xparams _params)
    {
        info = 0;
        x = new double[0];
        w = new double[0];
    ...
    *************************************************************************/
    ...
    public static void gqgenerategausslobattorec(double[] alpha, double[] beta, double mu0, double a, double b, int n, out int info, out double[] x, out double[] w, alg.xparams _params)
    {
        info = 0;
        x = new double[0];
        w = new double[0];
    ...
    *************************************************************************/
    ...
    public static void gqgenerategaussradaurec(double[] alpha, double[] beta, double mu0, double a, int n, out int info, out double[] x, out double[] w, alg.xparams _params)
    {
        info = 0;
        x = new double[0];
        w = new double[0];
    ...
    *************************************************************************/
    ...
    public static void gqgenerategausslegendre(int n, out int info, out double[] x, out double[] w, alg.xparams _params)
    {
        info = 0;
        x = new double[0];
        w = new double[0];
    ...
    *************************************************************************/
    ...
    public static void gqgenerategaussjacobi(int n, double alpha, double beta, out int info, out double[] x, out double[] w, alg.xparams _params)
    {
        info = 0;
        x = new double[0];
        w = new double[0];
    ...
    *************************************************************************/
    ...
    public static void gqgenerategausslaguerre(int n, double alpha, out int info, out double[] x, out double[] w, alg.xparams _params)
    {
        info = 0;
        x = new double[0];
        w = new double[0];
    ...
    *************************************************************************/
    ...
    public static void gqgenerategausshermite(int n, out int info, out double[] x, out double[] w, alg.xparams _params)
    {
        info = 0;
        x = new double[0];
        w = new double[0];
...
public partial class alg
{
    ...
    *************************************************************************/
    ...
    public static void gkqgeneraterec(double[] alpha, double[] beta, double mu0, int n, out int info, out double[] x, out double[] wkronrod, out double[] wgauss, alg.xparams _params)
    {
        info = 0;
        x = new double[0];
        wkronrod = new double[0];
    ...
    *************************************************************************/
    ...
    public static void gkqgenerategausslegendre(int n, out int info, out double[] x, out double[] wkronrod, out double[] wgauss, alg.xparams _params)
    {
        info = 0;
        x = new double[0];
        wkronrod = new double[0];
    ...
    *************************************************************************/
    ...
    public static void gkqgenerategaussjacobi(int n, double alpha, double beta, out int info, out double[] x, out double[] wkronrod, out double[] wgauss, alg.xparams _params)
    {
        info = 0;
        x = new double[0];
        wkronrod = new double[0];
    ...
    *************************************************************************/
    ...
    public static void gkqlegendrecalc(int n, out int info, out double[] x, out double[] wkronrod, out double[] wgauss, alg.xparams _params)
    {
        info = 0;
        x = new double[0];
        wkronrod = new double[0];
    ...
    *************************************************************************/
    ...
    public static void gkqlegendretbl(int n, out double[] x, out double[] wkronrod, out double[] wgauss, out double eps, alg.xparams _params)
    {
        x = new double[0];
        wkronrod = new double[0];
        wgauss = new double[0];
...
public partial class alg
{
    ...
    *************************************************************************/
    ...
    public static void autogksmooth(double a, double b, out autogkstate state, alg.xparams _params)
    {
        state = new autogkstate();
    ...
    *************************************************************************/
    ...
    public static void autogksmoothw(double a, double b, double xwidth, out autogkstate state, alg.xparams _params)
    {
        state = new autogkstate();
    ...
    *************************************************************************/
    ...
    public static void autogksingular(double a, double b, double alpha, double beta, out autogkstate state, alg.xparams _params)
    {
        state = new autogkstate();
    ...
    *************************************************************************/
    ...
    public static bool autogkiteration(autogkstate state, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void autogkintegrate(autogkstate state, integrator1_func func, object obj, alg.xparams _params)
    {
        if( func==null )
            throw new alglibexception("ALGLIB: error in 'autogkintegrate()' (func is null)");
        while( alg.autogkiteration(state, _params) )
        {
            if( state.needf )
            {
    ...
    *************************************************************************/
    ...
    public static void autogkresults(autogkstate state, out double v, out autogkreport rep, alg.xparams _params)
    {
        v = 0;
        rep = new autogkreport();
    ...
    public class gkq
    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            // Process
            //
            alg.ap.assert(((((n==15 || n==21) || n==31) || n==41) || n==51) || n==61, "GKQNodesTbl: incorrect N!");
            x = new double[n];
    ...
    public class autogk
    {
        ...
        *************************************************************************/
        public static void autogksmooth(double a,
            ...
            alg.xparams _params)
        {
            alg.ap.assert(math.isfinite(a), "AutoGKSmooth: A is not finite!");
            alg.ap.assert(math.isfinite(b), "AutoGKSmooth: B is not finite!");
        ...
        *************************************************************************/
        public static void autogksmoothw(double a,
            ...
            alg.xparams _params)
        {
            alg.ap.assert(math.isfinite(a), "AutoGKSmoothW: A is not finite!");
            alg.ap.assert(math.isfinite(b), "AutoGKSmoothW: B is not finite!");
            alg.ap.assert(math.isfinite(xwidth), "AutoGKSmoothW: XWidth is not finite!");
            state.wrappermode = 0;
            state.a = a;
            state.b = b;
            state.xwidth = xwidth;
        ...
        *************************************************************************/
        public static void autogksingular(double a,
            ...
            alg.xparams _params)
        {
            alg.ap.assert(math.isfinite(a), "AutoGKSingular: A is not finite!");
            alg.ap.assert(math.isfinite(b), "AutoGKSingular: B is not finite!");
            alg.ap.assert(math.isfinite(alpha), "AutoGKSingular: Alpha is not finite!");
            alg.ap.assert(math.isfinite(beta), "AutoGKSingular: Beta is not finite!");
            state.wrappermode = 1;
            state.a = a;
            state.b = b;
            state.alpha = alpha;
