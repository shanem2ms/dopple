...
public partial class alg
{
    ...
    *************************************************************************/
    public class kdtreerequestbuffer : alglibobject
    {
        ...
        public override alg.alglibobject make_copy()
        {
    ...
    *************************************************************************/
    ...
    {
        alg.serializer s = new alg.serializer();
        s.alloc_start();
    ...
    *************************************************************************/
    ...
    public static void kdtreebuild(double[,] xy, int n, int nx, int ny, int normtype, out kdtree kdt, alg.xparams _params)
    {
        kdt = new kdtree();
    ...
    public static void kdtreebuild(double[,] xy, int nx, int ny, int normtype, out kdtree kdt, alg.xparams _params)
    {
        int n;
    ...
    *************************************************************************/
    ...
    public static void kdtreebuildtagged(double[,] xy, int[] tags, int n, int nx, int ny, int normtype, out kdtree kdt, alg.xparams _params)
    {
        kdt = new kdtree();
    ...
    public static void kdtreebuildtagged(double[,] xy, int[] tags, int nx, int ny, int normtype, out kdtree kdt, alg.xparams _params)
    {
        int n;
        if( (ap.rows(xy)!=ap.len(tags)))
            throw new alglibexception("Error while calling 'kdtreebuildtagged': looks like one of arguments has wrong size");
    ...
    *************************************************************************/
    ...
    public static void kdtreecreaterequestbuffer(kdtree kdt, out kdtreerequestbuffer buf, alg.xparams _params)
    {
        buf = new kdtreerequestbuffer();
    ...
    *************************************************************************/
    ...
    public static int kdtreequeryknn(kdtree kdt, double[] x, int k, bool selfmatch, alg.xparams _params)
    {
    ...
    public static int kdtreequeryknn(kdtree kdt, double[] x, int k, alg.xparams _params)
    {
        bool selfmatch;
    ...
    *************************************************************************/
    ...
    public static int kdtreetsqueryknn(kdtree kdt, kdtreerequestbuffer buf, double[] x, int k, bool selfmatch, alg.xparams _params)
    {
    ...
    public static int kdtreetsqueryknn(kdtree kdt, kdtreerequestbuffer buf, double[] x, int k, alg.xparams _params)
    {
        bool selfmatch;
    ...
    *************************************************************************/
    ...
    public static int kdtreequeryrnn(kdtree kdt, double[] x, double r, bool selfmatch, alg.xparams _params)
    {
    ...
    public static int kdtreequeryrnn(kdtree kdt, double[] x, double r, alg.xparams _params)
    {
        bool selfmatch;
    ...
    *************************************************************************/
    ...
    public static int kdtreequeryrnnu(kdtree kdt, double[] x, double r, bool selfmatch, alg.xparams _params)
    {
    ...
    public static int kdtreequeryrnnu(kdtree kdt, double[] x, double r, alg.xparams _params)
    {
        bool selfmatch;
    ...
    *************************************************************************/
    ...
    public static int kdtreetsqueryrnn(kdtree kdt, kdtreerequestbuffer buf, double[] x, double r, bool selfmatch, alg.xparams _params)
    {
    ...
    public static int kdtreetsqueryrnn(kdtree kdt, kdtreerequestbuffer buf, double[] x, double r, alg.xparams _params)
    {
        bool selfmatch;
    ...
    *************************************************************************/
    ...
    public static int kdtreetsqueryrnnu(kdtree kdt, kdtreerequestbuffer buf, double[] x, double r, bool selfmatch, alg.xparams _params)
    {
    ...
    public static int kdtreetsqueryrnnu(kdtree kdt, kdtreerequestbuffer buf, double[] x, double r, alg.xparams _params)
    {
        bool selfmatch;
    ...
    *************************************************************************/
    ...
    public static int kdtreequeryaknn(kdtree kdt, double[] x, int k, bool selfmatch, double eps, alg.xparams _params)
    {
    ...
    public static int kdtreequeryaknn(kdtree kdt, double[] x, int k, double eps, alg.xparams _params)
    {
        bool selfmatch;
    ...
    *************************************************************************/
    ...
    public static int kdtreetsqueryaknn(kdtree kdt, kdtreerequestbuffer buf, double[] x, int k, bool selfmatch, double eps, alg.xparams _params)
    {
    ...
    public static int kdtreetsqueryaknn(kdtree kdt, kdtreerequestbuffer buf, double[] x, int k, double eps, alg.xparams _params)
    {
        bool selfmatch;
    ...
    *************************************************************************/
    ...
    public static int kdtreequerybox(kdtree kdt, double[] boxmin, double[] boxmax, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static int kdtreetsquerybox(kdtree kdt, kdtreerequestbuffer buf, double[] boxmin, double[] boxmax, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void kdtreequeryresultsx(kdtree kdt, ref double[,] x, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void kdtreequeryresultsxy(kdtree kdt, ref double[,] xy, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void kdtreequeryresultstags(kdtree kdt, ref int[] tags, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void kdtreequeryresultsdistances(kdtree kdt, ref double[] r, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void kdtreetsqueryresultsx(kdtree kdt, kdtreerequestbuffer buf, ref double[,] x, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void kdtreetsqueryresultsxy(kdtree kdt, kdtreerequestbuffer buf, ref double[,] xy, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void kdtreetsqueryresultstags(kdtree kdt, kdtreerequestbuffer buf, ref int[] tags, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void kdtreetsqueryresultsdistances(kdtree kdt, kdtreerequestbuffer buf, ref double[] r, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void kdtreequeryresultsxi(kdtree kdt, out double[,] x, alg.xparams _params)
    {
        x = new double[0,0];
    ...
    *************************************************************************/
    ...
    public static void kdtreequeryresultsxyi(kdtree kdt, out double[,] xy, alg.xparams _params)
    {
        xy = new double[0,0];
    ...
    *************************************************************************/
    ...
    public static void kdtreequeryresultstagsi(kdtree kdt, out int[] tags, alg.xparams _params)
    {
        tags = new int[0];
    ...
    *************************************************************************/
    ...
    public static void kdtreequeryresultsdistancesi(kdtree kdt, out double[] r, alg.xparams _params)
    {
        r = new double[0];
...
public partial class alg
{
    ...
    *************************************************************************/
    ...
    public static void hqrndrandomize(out hqrndstate state, alg.xparams _params)
    {
        state = new hqrndstate();
    ...
    *************************************************************************/
    ...
    public static void hqrndseed(int s1, int s2, out hqrndstate state, alg.xparams _params)
    {
        state = new hqrndstate();
    ...
    *************************************************************************/
    ...
    public static double hqrnduniformr(hqrndstate state, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static int hqrnduniformi(hqrndstate state, int n, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static double hqrndnormal(hqrndstate state, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void hqrndunit2(hqrndstate state, out double x, out double y, alg.xparams _params)
    {
        x = 0;
        y = 0;
    ...
    *************************************************************************/
    ...
    public static void hqrndnormal2(hqrndstate state, out double x1, out double x2, alg.xparams _params)
    {
        x1 = 0;
        x2 = 0;
    ...
    *************************************************************************/
    ...
    public static double hqrndexponential(hqrndstate state, double lambdav, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static double hqrnddiscrete(hqrndstate state, double[] x, int n, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static double hqrndcontinuous(hqrndstate state, double[] x, int n, alg.xparams _params)
    {
...
public partial class alg
{
    ...
    *************************************************************************/
    ...
    public static void xdebuginitrecord1(out xdebugrecord1 rec1, alg.xparams _params)
    {
        rec1 = new xdebugrecord1();
    ...
    *************************************************************************/
    ...
    public static int xdebugb1count(bool[] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugb1not(ref bool[] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugb1appendcopy(ref bool[] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugb1outeven(int n, out bool[] a, alg.xparams _params)
    {
        a = new bool[0];
    ...
    *************************************************************************/
    ...
    public static int xdebugi1sum(int[] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugi1neg(ref int[] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugi1appendcopy(ref int[] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugi1outeven(int n, out int[] a, alg.xparams _params)
    {
        a = new int[0];
    ...
    *************************************************************************/
    ...
    public static double xdebugr1sum(double[] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugr1neg(ref double[] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugr1appendcopy(ref double[] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugr1outeven(int n, out double[] a, alg.xparams _params)
    {
        a = new double[0];
    ...
    *************************************************************************/
    ...
    public static complex xdebugc1sum(complex[] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugc1neg(ref complex[] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugc1appendcopy(ref complex[] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugc1outeven(int n, out complex[] a, alg.xparams _params)
    {
        a = new complex[0];
    ...
    *************************************************************************/
    ...
    public static int xdebugb2count(bool[,] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugb2not(ref bool[,] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugb2transpose(ref bool[,] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugb2outsin(int m, int n, out bool[,] a, alg.xparams _params)
    {
        a = new bool[0,0];
    ...
    *************************************************************************/
    ...
    public static int xdebugi2sum(int[,] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugi2neg(ref int[,] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugi2transpose(ref int[,] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugi2outsin(int m, int n, out int[,] a, alg.xparams _params)
    {
        a = new int[0,0];
    ...
    *************************************************************************/
    ...
    public static double xdebugr2sum(double[,] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugr2neg(ref double[,] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugr2transpose(ref double[,] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugr2outsin(int m, int n, out double[,] a, alg.xparams _params)
    {
        a = new double[0,0];
    ...
    *************************************************************************/
    ...
    public static complex xdebugc2sum(complex[,] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugc2neg(ref complex[,] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugc2transpose(ref complex[,] a, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void xdebugc2outsincos(int m, int n, out complex[,] a, alg.xparams _params)
    {
        a = new complex[0,0];
    ...
    *************************************************************************/
    ...
    public static double xdebugmaskedbiasedproductsum(int m, int n, double[,] a, double[,] b, bool[,] c, alg.xparams _params)
    {
    ...
    public class nearestneighbor
    {
        ...
        *************************************************************************/
        public class kdtreerequestbuffer : apobject
        {
            ...
            public override alg.apobject make_copy()
            {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>=0, "KDTreeBuild: N<0");
            alg.ap.assert(nx>=1, "KDTreeBuild: NX<1");
            alg.ap.assert(ny>=0, "KDTreeBuild: NY<0");
            alg.ap.assert(normtype>=0 && normtype<=2, "KDTreeBuild: incorrect NormType");
            alg.ap.assert(alg.ap.rows(xy)>=n, "KDTreeBuild: rows(X)<N");
            alg.ap.assert(alg.ap.cols(xy)>=nx+ny || n==0, "KDTreeBuild: cols(X)<NX+NY");
            alg.ap.assert(apserv.apservisfinitematrix(xy, n, nx+ny, _params), "KDTreeBuild: XY contains infinite or NaN values");
            if( n>0 )
            {
                tags = new int[n];
                for(i=0; i<=n-1; i++)
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>=0, "KDTreeBuildTagged: N<0");
            alg.ap.assert(nx>=1, "KDTreeBuildTagged: NX<1");
            alg.ap.assert(ny>=0, "KDTreeBuildTagged: NY<0");
            alg.ap.assert(normtype>=0 && normtype<=2, "KDTreeBuildTagged: incorrect NormType");
            alg.ap.assert(alg.ap.rows(xy)>=n, "KDTreeBuildTagged: rows(X)<N");
            alg.ap.assert(alg.ap.cols(xy)>=nx+ny || n==0, "KDTreeBuildTagged: cols(X)<NX+NY");
            alg.ap.assert(apserv.apservisfinitematrix(xy, n, nx+ny, _params), "KDTreeBuildTagged: XY contains infinite or NaN values");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(k>=1, "KDTreeQueryKNN: K<1!");
            alg.ap.assert(alg.ap.len(x)>=kdt.nx, "KDTreeQueryKNN: Length(X)<NX!");
            alg.ap.assert(apserv.isfinitevector(x, kdt.nx, _params), "KDTreeQueryKNN: X contains infinite or NaN values!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(k>=1, "KDTreeTsQueryKNN: K<1!");
            alg.ap.assert(alg.ap.len(x)>=kdt.nx, "KDTreeTsQueryKNN: Length(X)<NX!");
            alg.ap.assert(apserv.isfinitevector(x, kdt.nx, _params), "KDTreeTsQueryKNN: X contains infinite or NaN values!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert((double)(r)>(double)(0), "KDTreeQueryRNN: incorrect R!");
            alg.ap.assert(alg.ap.len(x)>=kdt.nx, "KDTreeQueryRNN: Length(X)<NX!");
            alg.ap.assert(apserv.isfinitevector(x, kdt.nx, _params), "KDTreeQueryRNN: X contains infinite or NaN values!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert((double)(r)>(double)(0), "KDTreeQueryRNNU: incorrect R!");
            alg.ap.assert(alg.ap.len(x)>=kdt.nx, "KDTreeQueryRNNU: Length(X)<NX!");
            alg.ap.assert(apserv.isfinitevector(x, kdt.nx, _params), "KDTreeQueryRNNU: X contains infinite or NaN values!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(math.isfinite(r) && (double)(r)>(double)(0), "KDTreeTsQueryRNN: incorrect R!");
            alg.ap.assert(alg.ap.len(x)>=kdt.nx, "KDTreeTsQueryRNN: Length(X)<NX!");
            alg.ap.assert(apserv.isfinitevector(x, kdt.nx, _params), "KDTreeTsQueryRNN: X contains infinite or NaN values!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(math.isfinite(r) && (double)(r)>(double)(0), "KDTreeTsQueryRNNU: incorrect R!");
            alg.ap.assert(alg.ap.len(x)>=kdt.nx, "KDTreeTsQueryRNNU: Length(X)<NX!");
            alg.ap.assert(apserv.isfinitevector(x, kdt.nx, _params), "KDTreeTsQueryRNNU: X contains infinite or NaN values!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(k>0, "KDTreeTsQueryAKNN: incorrect K!");
            alg.ap.assert((double)(eps)>=(double)(0), "KDTreeTsQueryAKNN: incorrect Eps!");
            alg.ap.assert(alg.ap.len(x)>=kdt.nx, "KDTreeTsQueryAKNN: Length(X)<NX!");
            alg.ap.assert(apserv.isfinitevector(x, kdt.nx, _params), "KDTreeTsQueryAKNN: X contains infinite or NaN values!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(alg.ap.len(boxmin)>=kdt.nx, "KDTreeTsQueryBox: Length(BoxMin)<NX!");
            alg.ap.assert(alg.ap.len(boxmax)>=kdt.nx, "KDTreeTsQueryBox: Length(BoxMax)<NX!");
            alg.ap.assert(apserv.isfinitevector(boxmin, kdt.nx, _params), "KDTreeTsQueryBox: BoxMin contains infinite or NaN values!");
            alg.ap.assert(apserv.isfinitevector(boxmax, kdt.nx, _params), "KDTreeTsQueryBox: BoxMax contains infinite or NaN values!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            if( alg.ap.rows(x)<buf.kcur || alg.ap.cols(x)<kdt.nx )
            {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            if( alg.ap.rows(xy)<buf.kcur || alg.ap.cols(xy)<kdt.nx+kdt.ny )
            {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(node>=0, "KDTreeExploreNodeType: incorrect node");
            alg.ap.assert(node<alg.ap.len(kdt.nodes), "KDTreeExploreNodeType: incorrect node");
            if( kdt.nodes[node]>0 )
            {
            ...
            alg.ap.assert(false, "KDTreeExploreNodeType: integrity check failure");
        }
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(node>=0, "KDTreeExploreLeaf: incorrect node index");
            alg.ap.assert(node+1<alg.ap.len(kdt.nodes), "KDTreeExploreLeaf: incorrect node index");
            alg.ap.assert(kdt.nodes[node]>0, "KDTreeExploreLeaf: incorrect node index");
            k = kdt.nodes[node];
            offs = kdt.nodes[node+1];
            alg.ap.assert(offs>=0, "KDTreeExploreLeaf: integrity error");
            alg.ap.assert(offs+k-1<alg.ap.rows(kdt.xy), "KDTreeExploreLeaf: integrity error");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(node>=0, "KDTreeExploreSplit: incorrect node index");
            alg.ap.assert(node+4<alg.ap.len(kdt.nodes), "KDTreeExploreSplit: incorrect node index");
            alg.ap.assert(kdt.nodes[node]==0, "KDTreeExploreSplit: incorrect node index");
            d = kdt.nodes[node+1];
            s = kdt.splits[kdt.nodes[node+2]];
            nodele = kdt.nodes[node+3];
            nodege = kdt.nodes[node+4];
            alg.ap.assert(d>=0, "KDTreeExploreSplit: integrity failure");
            alg.ap.assert(d<kdt.nx, "KDTreeExploreSplit: integrity failure");
            alg.ap.assert(math.isfinite(s), "KDTreeExploreSplit: integrity failure");
            alg.ap.assert(nodele>=0, "KDTreeExploreSplit: integrity failure");
            alg.ap.assert(nodele<alg.ap.len(kdt.nodes), "KDTreeExploreSplit: integrity failure");
            alg.ap.assert(nodege>=0, "KDTreeExploreSplit: integrity failure");
            alg.ap.assert(nodege<alg.ap.len(kdt.nodes), "KDTreeExploreSplit: integrity failure");
        }
        ...
        *************************************************************************/
        public static void kdtreealloc(alg.serializer s,
            kdtree tree,
            alg.xparams _params)
        {
        ...
        Serializer: serialization
          ...
          -- ALGLIB --
             Copyright 14.03.2011 by Bochkanov Sergey
        *************************************************************************/
        public static void kdtreeserialize(alg.serializer s,
            kdtree tree,
            alg.xparams _params)
        {
        ...
        Serializer: unserialization
          ...
          -- ALGLIB --
             Copyright 14.03.2011 by Bochkanov Sergey
        *************************************************************************/
        public static void kdtreeunserialize(alg.serializer s,
            kdtree tree,
            alg.xparams _params)
        {
            int i0 = 0;
            ...
            alg.ap.assert(i0==scodes.getkdtreeserializationcode(_params), "KDTreeUnserialize: stream header corrupted");
            i1 = s.unserialize_int();
            alg.ap.assert(i1==kdtreefirstversion, "KDTreeUnserialize: stream header corrupted");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(kdt.n>0, "KDTreeSplit: internal error");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(kdt.n>0, "KDTreeGenerateTreeRec: internal error");
            alg.ap.assert(i2>i1, "KDTreeGenerateTreeRec: internal error");
            ...
            //
            alg.ap.assert(splitnodesize==6, "KDTreeGenerateTreeRec: node size has unexpectedly changed");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(kdt.n>0, "KDTreeQueryNNRec: internal error");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(kdt.n>0, "KDTreeQueryBoxRec: internal error");
            nx = kdt.nx;
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(kdt.n>0, "KDTreeInitBox: internal error");
        ...
        *************************************************************************/
        private static void kdtreeallocdatasetindependent(kdtree kdt,
            ...
            alg.xparams _params)
        {
            alg.ap.assert(kdt.n>0, "KDTreeAllocDatasetIndependent: internal error");
        ...
        *************************************************************************/
        private static void kdtreeallocdatasetdependent(kdtree kdt,
            ...
            alg.xparams _params)
        {
            alg.ap.assert(n>0, "KDTreeAllocDatasetDependent: internal error");
        ...
        *************************************************************************/
        private static void checkrequestbufferconsistency(kdtree kdt,
            ...
            alg.xparams _params)
        {
            alg.ap.assert(alg.ap.len(buf.x)>=kdt.nx, "KDTree: dimensions of kdtreerequestbuffer are inconsistent with kdtree structure");
            alg.ap.assert(alg.ap.len(buf.idx)>=kdt.n, "KDTree: dimensions of kdtreerequestbuffer are inconsistent with kdtree structure");
            alg.ap.assert(alg.ap.len(buf.r)>=kdt.n, "KDTree: dimensions of kdtreerequestbuffer are inconsistent with kdtree structure");
            alg.ap.assert(alg.ap.len(buf.buf)>=Math.Max(kdt.n, kdt.nx), "KDTree: dimensions of kdtreerequestbuffer are inconsistent with kdtree structure");
            alg.ap.assert(alg.ap.len(buf.curboxmin)>=kdt.nx, "KDTree: dimensions of kdtreerequestbuffer are inconsistent with kdtree structure");
            alg.ap.assert(alg.ap.len(buf.curboxmax)>=kdt.nx, "KDTree: dimensions of kdtreerequestbuffer are inconsistent with kdtree structure");
        }
    ...
    public class hqrnd
    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "HQRNDUniformI: N<=0!");
            maxcnt = hqrndmax+1;
            ...
            if( n>maxcnt )
            {
                ...
                if( n%maxcnt==0 )
                {
                    ...
                    //
                    alg.ap.assert(n/maxcnt<=maxcnt, "HQRNDUniformI: N is too large");
                ...
                else
                {
                    ...
                    //
                    alg.ap.assert(n/maxcnt+1<=maxcnt, "HQRNDUniformI: N is too large");
                    result = -1;
                    do
                    {
                        a = hqrnduniformi(state, maxcnt, _params);
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert((double)(lambdav)>(double)(0), "HQRNDExponential: LambdaV<=0!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "HQRNDDiscrete: N<=0");
            alg.ap.assert(n<=alg.ap.len(x), "HQRNDDiscrete: Length(X)<N");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "HQRNDContinuous: N<=0");
            alg.ap.assert(n<=alg.ap.len(x), "HQRNDContinuous: Length(X)<N");
            if( n==1 )
            {
                result = x[0];
                return result;
            ...
            mn = x[i];
            mx = x[i+1];
            alg.ap.assert((double)(mx)>=(double)(mn), "HQRNDDiscrete: X is not sorted by ascending");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(state.magicv==hqrndmagic, "HQRNDIntegerBase: State is not correctly initialized!");
            k = state.s1/53668;
    ...
    public class xdebug
    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            b = new bool[alg.ap.len(a)];
            for(i=0; i<=alg.ap.len(b)-1; i++)
            {
                b[i] = a[i];
            }
            a = new bool[2*alg.ap.len(b)];
            for(i=0; i<=alg.ap.len(a)-1; i++)
            {
                a[i] = b[i%alg.ap.len(b)];
            }
        }
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            b = new int[alg.ap.len(a)];
            for(i=0; i<=alg.ap.len(b)-1; i++)
            {
                b[i] = a[i];
            }
            a = new int[2*alg.ap.len(b)];
            for(i=0; i<=alg.ap.len(a)-1; i++)
            {
                a[i] = b[i%alg.ap.len(b)];
            }
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            b = new double[alg.ap.len(a)];
            for(i=0; i<=alg.ap.len(b)-1; i++)
            {
                b[i] = a[i];
            }
            a = new double[2*alg.ap.len(b)];
            for(i=0; i<=alg.ap.len(a)-1; i++)
            {
                a[i] = b[i%alg.ap.len(b)];
            }
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            b = new complex[alg.ap.len(a)];
            for(i=0; i<=alg.ap.len(b)-1; i++)
            {
                b[i] = a[i];
            }
            a = new complex[2*alg.ap.len(b)];
            for(i=0; i<=alg.ap.len(a)-1; i++)
            {
                a[i] = b[i%alg.ap.len(b)];
            }
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            result = 0;
            for(i=0; i<=alg.ap.rows(a)-1; i++)
            {
                for(j=0; j<=alg.ap.cols(a)-1; j++)
                {
                    if( a[i,j] )
                    {
                        result = result+1;
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            b = new bool[alg.ap.rows(a), alg.ap.cols(a)];
            for(i=0; i<=alg.ap.rows(b)-1; i++)
            {
                for(j=0; j<=alg.ap.cols(b)-1; j++)
                {
                    b[i,j] = a[i,j];
                }
            }
            a = new bool[alg.ap.cols(b), alg.ap.rows(b)];
            for(i=0; i<=alg.ap.rows(b)-1; i++)
            {
                for(j=0; j<=alg.ap.cols(b)-1; j++)
                {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            b = new int[alg.ap.rows(a), alg.ap.cols(a)];
            for(i=0; i<=alg.ap.rows(b)-1; i++)
            {
                for(j=0; j<=alg.ap.cols(b)-1; j++)
                {
            ...
            a = new int[alg.ap.cols(b), alg.ap.rows(b)];
            for(i=0; i<=alg.ap.rows(b)-1; i++)
            {
                for(j=0; j<=alg.ap.cols(b)-1; j++)
                {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            b = new double[alg.ap.rows(a), alg.ap.cols(a)];
            for(i=0; i<=alg.ap.rows(b)-1; i++)
            {
                for(j=0; j<=alg.ap.cols(b)-1; j++)
                {
            ...
            a = new double[alg.ap.cols(b), alg.ap.rows(b)];
            for(i=0; i<=alg.ap.rows(b)-1; i++)
            {
                for(j=0; j<=alg.ap.cols(b)-1; j++)
                {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            b = new complex[alg.ap.rows(a), alg.ap.cols(a)];
            for(i=0; i<=alg.ap.rows(b)-1; i++)
            {
                for(j=0; j<=alg.ap.cols(b)-1; j++)
                {
            ...
            a = new complex[alg.ap.cols(b), alg.ap.rows(b)];
            for(i=0; i<=alg.ap.rows(b)-1; i++)
            {
                for(j=0; j<=alg.ap.cols(b)-1; j++)
                {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(m>=alg.ap.rows(a));
            alg.ap.assert(m>=alg.ap.rows(b));
            alg.ap.assert(m>=alg.ap.rows(c));
            alg.ap.assert(n>=alg.ap.cols(a));
            alg.ap.assert(n>=alg.ap.cols(b));
            alg.ap.assert(n>=alg.ap.cols(c));
            result = 0.0;
            for(i=0; i<=m-1; i++)
            {
                for(j=0; j<=n-1; j++)
