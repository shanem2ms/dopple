...
public partial class alg
{
    ...
    *************************************************************************/
    ...
    public static void rmatrixsolve(double[,] a, int n, double[] b, out int info, out densesolverreport rep, out double[] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new double[0];
    ...
    *************************************************************************/
    ...
    public static void rmatrixsolvefast(double[,] a, int n, ref double[] b, out int info, alg.xparams _params)
    {
        info = 0;
    ...
    *************************************************************************/
    ...
    public static void rmatrixsolvem(double[,] a, int n, double[,] b, int m, bool rfs, out int info, out densesolverreport rep, out double[,] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new double[0,0];
    ...
    *************************************************************************/
    ...
    public static void rmatrixsolvemfast(double[,] a, int n, ref double[,] b, int m, out int info, alg.xparams _params)
    {
        info = 0;
    ...
    *************************************************************************/
    ...
    public static void rmatrixlusolve(double[,] lua, int[] p, int n, double[] b, out int info, out densesolverreport rep, out double[] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new double[0];
    ...
    *************************************************************************/
    ...
    public static void rmatrixlusolvefast(double[,] lua, int[] p, int n, ref double[] b, out int info, alg.xparams _params)
    {
        info = 0;
    ...
    *************************************************************************/
    ...
    public static void rmatrixlusolvem(double[,] lua, int[] p, int n, double[,] b, int m, out int info, out densesolverreport rep, out double[,] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new double[0,0];
    ...
    *************************************************************************/
    ...
    public static void rmatrixlusolvemfast(double[,] lua, int[] p, int n, ref double[,] b, int m, out int info, alg.xparams _params)
    {
        info = 0;
    ...
    *************************************************************************/
    ...
    public static void rmatrixmixedsolve(double[,] a, double[,] lua, int[] p, int n, double[] b, out int info, out densesolverreport rep, out double[] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new double[0];
    ...
    *************************************************************************/
    ...
    public static void rmatrixmixedsolvem(double[,] a, double[,] lua, int[] p, int n, double[,] b, int m, out int info, out densesolverreport rep, out double[,] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new double[0,0];
    ...
    *************************************************************************/
    ...
    public static void cmatrixsolvem(complex[,] a, int n, complex[,] b, int m, bool rfs, out int info, out densesolverreport rep, out complex[,] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new complex[0,0];
    ...
    *************************************************************************/
    ...
    public static void cmatrixsolvemfast(complex[,] a, int n, ref complex[,] b, int m, out int info, alg.xparams _params)
    {
        info = 0;
    ...
    *************************************************************************/
    ...
    public static void cmatrixsolve(complex[,] a, int n, complex[] b, out int info, out densesolverreport rep, out complex[] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new complex[0];
    ...
    *************************************************************************/
    ...
    public static void cmatrixsolvefast(complex[,] a, int n, ref complex[] b, out int info, alg.xparams _params)
    {
        info = 0;
    ...
    *************************************************************************/
    ...
    public static void cmatrixlusolvem(complex[,] lua, int[] p, int n, complex[,] b, int m, out int info, out densesolverreport rep, out complex[,] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new complex[0,0];
    ...
    *************************************************************************/
    ...
    public static void cmatrixlusolvemfast(complex[,] lua, int[] p, int n, ref complex[,] b, int m, out int info, alg.xparams _params)
    {
        info = 0;
    ...
    *************************************************************************/
    ...
    public static void cmatrixlusolve(complex[,] lua, int[] p, int n, complex[] b, out int info, out densesolverreport rep, out complex[] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new complex[0];
    ...
    *************************************************************************/
    ...
    public static void cmatrixlusolvefast(complex[,] lua, int[] p, int n, ref complex[] b, out int info, alg.xparams _params)
    {
        info = 0;
    ...
    *************************************************************************/
    ...
    public static void cmatrixmixedsolvem(complex[,] a, complex[,] lua, int[] p, int n, complex[,] b, int m, out int info, out densesolverreport rep, out complex[,] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new complex[0,0];
    ...
    *************************************************************************/
    ...
    public static void cmatrixmixedsolve(complex[,] a, complex[,] lua, int[] p, int n, complex[] b, out int info, out densesolverreport rep, out complex[] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new complex[0];
    ...
    *************************************************************************/
    ...
    public static void spdmatrixsolvem(double[,] a, int n, bool isupper, double[,] b, int m, out int info, out densesolverreport rep, out double[,] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new double[0,0];
    ...
    *************************************************************************/
    ...
    public static void spdmatrixsolvemfast(double[,] a, int n, bool isupper, ref double[,] b, int m, out int info, alg.xparams _params)
    {
        info = 0;
    ...
    *************************************************************************/
    ...
    public static void spdmatrixsolve(double[,] a, int n, bool isupper, double[] b, out int info, out densesolverreport rep, out double[] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new double[0];
    ...
    *************************************************************************/
    ...
    public static void spdmatrixsolvefast(double[,] a, int n, bool isupper, ref double[] b, out int info, alg.xparams _params)
    {
        info = 0;
    ...
    *************************************************************************/
    ...
    public static void spdmatrixcholeskysolvem(double[,] cha, int n, bool isupper, double[,] b, int m, out int info, out densesolverreport rep, out double[,] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new double[0,0];
    ...
    *************************************************************************/
    ...
    public static void spdmatrixcholeskysolvemfast(double[,] cha, int n, bool isupper, ref double[,] b, int m, out int info, alg.xparams _params)
    {
        info = 0;
    ...
    *************************************************************************/
    ...
    public static void spdmatrixcholeskysolve(double[,] cha, int n, bool isupper, double[] b, out int info, out densesolverreport rep, out double[] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new double[0];
    ...
    *************************************************************************/
    ...
    public static void spdmatrixcholeskysolvefast(double[,] cha, int n, bool isupper, ref double[] b, out int info, alg.xparams _params)
    {
        info = 0;
    ...
    *************************************************************************/
    ...
    public static void hpdmatrixsolvem(complex[,] a, int n, bool isupper, complex[,] b, int m, out int info, out densesolverreport rep, out complex[,] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new complex[0,0];
    ...
    *************************************************************************/
    ...
    public static void hpdmatrixsolvemfast(complex[,] a, int n, bool isupper, ref complex[,] b, int m, out int info, alg.xparams _params)
    {
        info = 0;
    ...
    *************************************************************************/
    ...
    public static void hpdmatrixsolve(complex[,] a, int n, bool isupper, complex[] b, out int info, out densesolverreport rep, out complex[] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new complex[0];
    ...
    *************************************************************************/
    ...
    public static void hpdmatrixsolvefast(complex[,] a, int n, bool isupper, ref complex[] b, out int info, alg.xparams _params)
    {
        info = 0;
    ...
    *************************************************************************/
    ...
    public static void hpdmatrixcholeskysolvem(complex[,] cha, int n, bool isupper, complex[,] b, int m, out int info, out densesolverreport rep, out complex[,] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new complex[0,0];
    ...
    *************************************************************************/
    ...
    public static void hpdmatrixcholeskysolvemfast(complex[,] cha, int n, bool isupper, ref complex[,] b, int m, out int info, alg.xparams _params)
    {
        info = 0;
    ...
    *************************************************************************/
    ...
    public static void hpdmatrixcholeskysolve(complex[,] cha, int n, bool isupper, complex[] b, out int info, out densesolverreport rep, out complex[] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverreport();
        x = new complex[0];
    ...
    *************************************************************************/
    ...
    public static void hpdmatrixcholeskysolvefast(complex[,] cha, int n, bool isupper, ref complex[] b, out int info, alg.xparams _params)
    {
        info = 0;
    ...
    *************************************************************************/
    ...
    public static void rmatrixsolvels(double[,] a, int nrows, int ncols, double[] b, double threshold, out int info, out densesolverlsreport rep, out double[] x, alg.xparams _params)
    {
        info = 0;
        rep = new densesolverlsreport();
        x = new double[0];
...
public partial class alg
{
    ...
    *************************************************************************/
    ...
    public static void linlsqrcreate(int m, int n, out linlsqrstate state, alg.xparams _params)
    {
        state = new linlsqrstate();
    ...
    *************************************************************************/
    ...
    public static void linlsqrcreatebuf(int m, int n, linlsqrstate state, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void linlsqrsetprecunit(linlsqrstate state, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void linlsqrsetprecdiag(linlsqrstate state, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void linlsqrsetlambdai(linlsqrstate state, double lambdai, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void linlsqrsolvesparse(linlsqrstate state, sparsematrix a, double[] b, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void linlsqrsetcond(linlsqrstate state, double epsa, double epsb, int maxits, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void linlsqrresults(linlsqrstate state, out double[] x, out linlsqrreport rep, alg.xparams _params)
    {
        x = new double[0];
        rep = new linlsqrreport();
    ...
    *************************************************************************/
    ...
    public static void linlsqrsetxrep(linlsqrstate state, bool needxrep, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static int linlsqrpeekiterationscount(linlsqrstate s, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void linlsqrrequesttermination(linlsqrstate state, alg.xparams _params)
    {
...
public partial class alg
{
    ...
    *************************************************************************/
    ...
    public static void polynomialsolve(double[] a, int n, out complex[] x, out polynomialsolverreport rep, alg.xparams _params)
    {
        x = new complex[0];
        rep = new polynomialsolverreport();
...
public partial class alg
{
    ...
    *************************************************************************/
    ...
    public static void nleqcreatelm(int n, int m, double[] x, out nleqstate state, alg.xparams _params)
    {
        state = new nleqstate();
    ...
    public static void nleqcreatelm(int m, double[] x, out nleqstate state, alg.xparams _params)
    {
        int n;
    ...
    *************************************************************************/
    ...
    public static void nleqsetcond(nleqstate state, double epsf, int maxits, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void nleqsetxrep(nleqstate state, bool needxrep, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void nleqsetstpmax(nleqstate state, double stpmax, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static bool nleqiteration(nleqstate state, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void nleqsolve(nleqstate state, ndimensional_func func, ndimensional_jac  jac, ndimensional_rep rep, object obj, alg.xparams _params)
    {
        if( func==null )
        ...
        while( alg.nleqiteration(state, _params) )
        {
            if( state.needf )
            {
    ...
    *************************************************************************/
    ...
    public static void nleqresults(nleqstate state, out double[] x, out nleqreport rep, alg.xparams _params)
    {
        x = new double[0];
        rep = new nleqreport();
    ...
    *************************************************************************/
    ...
    public static void nleqresultsbuf(nleqstate state, ref double[] x, nleqreport rep, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void nleqrestartfrom(nleqstate state, double[] x, alg.xparams _params)
    {
...
public partial class alg
{
    ...
    *************************************************************************/
    ...
    public static void sparsesolvesks(sparsematrix a, int n, bool isupper, double[] b, out sparsesolverreport rep, out double[] x, alg.xparams _params)
    {
        rep = new sparsesolverreport();
        x = new double[0];
    ...
    *************************************************************************/
    ...
    public static void sparsecholeskysolvesks(sparsematrix a, int n, bool isupper, double[] b, out sparsesolverreport rep, out double[] x, alg.xparams _params)
    {
        rep = new sparsesolverreport();
        x = new double[0];
...
public partial class alg
{
    ...
    *************************************************************************/
    ...
    public static void lincgcreate(int n, out lincgstate state, alg.xparams _params)
    {
        state = new lincgstate();
    ...
    *************************************************************************/
    ...
    public static void lincgsetstartingpoint(lincgstate state, double[] x, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void lincgsetprecunit(lincgstate state, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void lincgsetprecdiag(lincgstate state, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void lincgsetcond(lincgstate state, double epsf, int maxits, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void lincgsolvesparse(lincgstate state, sparsematrix a, bool isupper, double[] b, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void lincgresults(lincgstate state, out double[] x, out lincgreport rep, alg.xparams _params)
    {
        x = new double[0];
        rep = new lincgreport();
    ...
    *************************************************************************/
    ...
    public static void lincgsetrestartfreq(lincgstate state, int srf, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void lincgsetrupdatefreq(lincgstate state, int freq, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void lincgsetxrep(lincgstate state, bool needxrep, alg.xparams _params)
    {
    ...
    public class linlsqr
    {
        ...
        *************************************************************************/
        public static void linlsqrcreate(int m,
            ...
            alg.xparams _params)
        {
            alg.ap.assert(m>0, "LinLSQRCreate: M<=0");
            alg.ap.assert(n>0, "LinLSQRCreate: N<=0");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(m>0, "LinLSQRCreateBuf: M<=0");
            alg.ap.assert(n>0, "LinLSQRCreateBuf: N<=0");
            state.m = m;
            state.n = n;
            state.prectype = 0;
            state.epsa = atol;
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(!state.running, "LinLSQRSetB: you can not change B when LinLSQRIteration is running");
            alg.ap.assert(state.m<=alg.ap.len(b), "LinLSQRSetB: Length(B)<M");
            alg.ap.assert(apserv.isfinitevector(b, state.m, _params), "LinLSQRSetB: B contains infinite or NaN values");
            state.bnorm2 = 0;
        ...
        *************************************************************************/
        public static void linlsqrsetprecunit(linlsqrstate state,
            alg.xparams _params)
        {
            alg.ap.assert(!state.running, "LinLSQRSetPrecUnit: you can not change preconditioner, because function LinLSQRIteration is running!");
            state.prectype = -1;
        }
        ...
        *************************************************************************/
        public static void linlsqrsetprecdiag(linlsqrstate state,
            alg.xparams _params)
        {
            alg.ap.assert(!state.running, "LinLSQRSetPrecDiag: you can not change preconditioner, because function LinCGIteration is running!");
            state.prectype = 0;
        }
        ...
        *************************************************************************/
        public static void linlsqrsetlambdai(linlsqrstate state,
            ...
            alg.xparams _params)
        {
            alg.ap.assert(!state.running, "LinLSQRSetLambdaI: you can not set LambdaI, because function LinLSQRIteration is running");
            alg.ap.assert(math.isfinite(lambdai) && (double)(lambdai)>=(double)(0), "LinLSQRSetLambdaI: LambdaI is infinite or NaN");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            // Routine body
            //
            alg.ap.assert(alg.ap.len(state.b)>0, "LinLSQRIteration: using non-allocated array B");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            n = state.n;
            alg.ap.assert(!state.running, "LinLSQRSolveSparse: you can not call this function when LinLSQRIteration is running");
            alg.ap.assert(alg.ap.len(b)>=state.m, "LinLSQRSolveSparse: Length(B)<M");
            alg.ap.assert(apserv.isfinitevector(b, state.m, _params), "LinLSQRSolveSparse: B contains infinite or NaN values");
        ...
        *************************************************************************/
        public static void linlsqrsetcond(linlsqrstate state,
            ...
            alg.xparams _params)
        {
            alg.ap.assert(!state.running, "LinLSQRSetCond: you can not call this function when LinLSQRIteration is running");
            alg.ap.assert(math.isfinite(epsa) && (double)(epsa)>=(double)(0), "LinLSQRSetCond: EpsA is negative, INF or NAN");
            alg.ap.assert(math.isfinite(epsb) && (double)(epsb)>=(double)(0), "LinLSQRSetCond: EpsB is negative, INF or NAN");
            alg.ap.assert(maxits>=0, "LinLSQRSetCond: MaxIts is negative");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(!state.running, "LinLSQRResult: you can not call this function when LinLSQRIteration is running");
            if( alg.ap.len(x)<state.n )
            {
    ...
    public class polynomialsolver
    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "PolynomialSolve: N<=0");
            alg.ap.assert(alg.ap.len(a)>=n+1, "PolynomialSolve: Length(A)<N+1");
            alg.ap.assert(apserv.isfinitevector(a, n+1, _params), "PolynomialSolve: A contains infitite numbers");
            alg.ap.assert((double)(a[n])!=(double)(0), "PolynomialSolve: A[N]=0");
            ...
            if( ne>0 )
            {
                ...
                alg.ap.assert(status, "PolynomialSolve: inernal error - EVD solver failed");
                for(i=0; i<=ne-1; i++)
                {
                    x[i].x = wr[i];
                    x[i].y = wi[i];
    ...
    public class nleq
    {
        ...
        *************************************************************************/
        public static void nleqcreatelm(int n,
            ...
            alg.xparams _params)
        {
            alg.ap.assert(n>=1, "NLEQCreateLM: N<1!");
            alg.ap.assert(m>=1, "NLEQCreateLM: M<1!");
            alg.ap.assert(alg.ap.len(x)>=n, "NLEQCreateLM: Length(X)<N!");
            alg.ap.assert(apserv.isfinitevector(x, n, _params), "NLEQCreateLM: X contains infinite or NaN values!");
        ...
        *************************************************************************/
        public static void nleqsetcond(nleqstate state,
            ...
            alg.xparams _params)
        {
            alg.ap.assert(math.isfinite(epsf), "NLEQSetCond: EpsF is not finite number!");
            alg.ap.assert((double)(epsf)>=(double)(0), "NLEQSetCond: negative EpsF!");
            alg.ap.assert(maxits>=0, "NLEQSetCond: negative MaxIts!");
        ...
        *************************************************************************/
        public static void nleqsetstpmax(nleqstate state,
            ...
            alg.xparams _params)
        {
            alg.ap.assert(math.isfinite(stpmax), "NLEQSetStpMax: StpMax is not finite!");
            alg.ap.assert((double)(stpmax)>=(double)(0), "NLEQSetStpMax: StpMax<0!");
            state.stpmax = stpmax;
        }
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(alg.ap.len(x)>=state.n, "NLEQRestartFrom: Length(X)<N!");
            alg.ap.assert(apserv.isfinitevector(x, state.n, _params), "NLEQRestartFrom: X contains infinite or NaN values!");
            for(i_=0; i_<=state.n-1;i_++)
            {
                state.x[i_] = x[i_];
            }
    ...
    public class directsparsesolvers
    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "SparseSolveSKS: N<=0");
            alg.ap.assert(sparse.sparsegetnrows(a, _params)==n, "SparseSolveSKS: rows(A)!=N");
            alg.ap.assert(sparse.sparsegetncols(a, _params)==n, "SparseSolveSKS: cols(A)!=N");
            alg.ap.assert(alg.ap.len(b)>=n, "SparseSolveSKS: length(B)<N");
            alg.ap.assert(apserv.isfinitevector(b, n, _params), "SparseSolveSKS: B contains infinities or NANs");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(sparse.sparsegetnrows(a, _params)==n, "SparseSolveSKS: rows(A)!=N");
            alg.ap.assert(sparse.sparsegetncols(a, _params)==n, "SparseSolveSKS: cols(A)!=N");
            alg.ap.assert(sparse.sparseissks(a, _params), "SparseSolveSKS: A is not an SKS matrix");
            alg.ap.assert(alg.ap.len(b)>=n, "SparseSolveSKS: length(B)<N");
            alg.ap.assert(apserv.isfinitevector(b, n, _params), "SparseSolveSKS: B contains infinities or NANs");
            initreport(rep, _params);
            x = new double[n];
    ...
    public class lincg
    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "LinCGCreate: N<=0");
            state.n = n;
            state.prectype = 0;
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(!state.running, "LinCGSetStartingPoint: you can not change starting point because LinCGIteration() function is running");
            alg.ap.assert(state.n<=alg.ap.len(x), "LinCGSetStartingPoint: Length(X)<N");
            alg.ap.assert(apserv.isfinitevector(x, state.n, _params), "LinCGSetStartingPoint: X contains infinite or NaN values!");
            for(i_=0; i_<=state.n-1;i_++)
            {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(!state.running, "LinCGSetB: you can not set B, because function LinCGIteration is running!");
            alg.ap.assert(alg.ap.len(b)>=state.n, "LinCGSetB: Length(B)<N");
            alg.ap.assert(apserv.isfinitevector(b, state.n, _params), "LinCGSetB: B contains infinite or NaN values!");
            for(i_=0; i_<=state.n-1;i_++)
            {
                state.b[i_] = b[i_];
            }
        ...
        *************************************************************************/
        public static void lincgsetprecunit(lincgstate state,
            alg.xparams _params)
        {
            alg.ap.assert(!state.running, "LinCGSetPrecUnit: you can not change preconditioner, because function LinCGIteration is running!");
            state.prectype = -1;
        }
        ...
        *************************************************************************/
        public static void lincgsetprecdiag(lincgstate state,
            alg.xparams _params)
        {
            alg.ap.assert(!state.running, "LinCGSetPrecDiag: you can not change preconditioner, because function LinCGIteration is running!");
            state.prectype = 0;
        }
        ...
        *************************************************************************/
        public static void lincgsetcond(lincgstate state,
            ...
            alg.xparams _params)
        {
            alg.ap.assert(!state.running, "LinCGSetCond: you can not change stopping criteria when LinCGIteration() is running");
            alg.ap.assert(math.isfinite(epsf) && (double)(epsf)>=(double)(0), "LinCGSetCond: EpsF is negative or contains infinite or NaN values");
            alg.ap.assert(maxits>=0, "LinCGSetCond: MaxIts is negative");
            if( (double)(epsf)==(double)(0) && maxits==0 )
            {
                state.epsf = defaultprecision;
                state.maxits = maxits;
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            // Routine body
            //
            alg.ap.assert(alg.ap.len(state.b)>0, "LinCGIteration: B is not initialized (you must initialize B by LinCGSetB() call");
            state.running = true;
            state.repnmv = 0;
            clearrfields(state, _params);
            updateitersdata(state, _params);
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(!state.running, "LinCGResult: you can not get result, because function LinCGIteration has been launched!");
            if( alg.ap.len(x)<state.n )
            {
                x = new double[state.n];
            }
        ...
        *************************************************************************/
        public static void lincgsetrestartfreq(lincgstate state,
            ...
            alg.xparams _params)
        {
            alg.ap.assert(!state.running, "LinCGSetRestartFreq: you can not change restart frequency when LinCGIteration() is running");
            alg.ap.assert(srf>0, "LinCGSetRestartFreq: non-positive SRF");
        ...
        *************************************************************************/
        public static void lincgsetrupdatefreq(lincgstate state,
            ...
            alg.xparams _params)
        {
            alg.ap.assert(!state.running, "LinCGSetRUpdateFreq: you can not change update frequency when LinCGIteration() is running");
            alg.ap.assert(freq>=0, "LinCGSetRUpdateFreq: non-positive Freq");
