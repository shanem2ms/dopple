...
public partial class alg
{
    public class scodes
    {
        public static int getrdfserializationcode(alg.xparams _params)
        {
            int result = 0;
        ...
        public static int getkdtreeserializationcode(alg.xparams _params)
        {
            int result = 0;
        ...
        public static int getmlpserializationcode(alg.xparams _params)
        {
            int result = 0;
        ...
        public static int getmlpeserializationcode(alg.xparams _params)
        {
            int result = 0;
        ...
        public static int getrbfserializationcode(alg.xparams _params)
        {
            int result = 0;
        ...
        public static int getspline2dserializationcode(alg.xparams _params)
        {
            int result = 0;
        ...
        public static int getidwserializationcode(alg.xparams _params)
        {
            int result = 0;
        ...
        public static int getknnserializationcode(alg.xparams _params)
        {
            int result = 0;
    ...
    public class apserv
    {
        ...
        *************************************************************************/
        public class scomplexarray : apobject
        {
            ...
            public override alg.apobject make_copy()
            {
                ...
                _result.val = (alg.complex[])val.Clone();
                return _result;
            }
        };
        ...
        *************************************************************************/
        public static void seterrorflagdiff(ref bool flag,
            ...
            alg.xparams _params)
        {
            alg.ap.seterrorflag(ref flag, (double)(Math.Abs(val-refval))>(double)(tol*Math.Max(Math.Abs(refval), s)), "apserv.ap:162");
        }
        ...
        *************************************************************************/
        public static bool alwaysfalse(alg.xparams _params)
        {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>=1, "TaskGenInterpolationEqdist1D: N<1!");
            x = new double[n];
            y = new double[n];
            if( n>1 )
            {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>=1, "TaskGenInterpolation1DCheb1: N<1!");
            x = new double[n];
            y = new double[n];
            if( n>1 )
            {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>=1, "TaskGenInterpolation1DCheb2: N<1!");
            x = new double[n];
            y = new double[n];
            if( n>1 )
            {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>=1, "APSERVAreDistinct: internal error (N<1)");
            if( n==1 )
            {
            ...
            alg.ap.assert(!nonsorted, "APSERVAreDistinct: internal error (not sorted)");
            for(i=1; i<=n-1; i++)
            {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            if( m>0 && n>0 )
            {
                if( alg.ap.rows(x)<m || alg.ap.cols(x)<n )
                {
                    x = new double[m, n];
                }
            }
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            // Choose new size
            //
            n = Math.Max(n, (int)Math.Round(1.8*alg.ap.len(x)+1));
            
            //
            // Grow
            //
            n2 = alg.ap.len(x);
            alg.ap.swap(ref x, ref oldx);
            x = new bool[n];
            for(i=0; i<=n-1; i++)
            {
                if( i<n2 )
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            // Enough place?
            //
            if( alg.ap.rows(a)>=n && alg.ap.cols(a)>=mincols )
            {
                return;
            }
            ...
            if( alg.ap.rows(a)<n )
            {
                n = Math.Max(n, (int)Math.Round(1.8*alg.ap.rows(a)+1));
            }
            n2 = Math.Min(alg.ap.rows(a), n);
            m = alg.ap.cols(a);
            
            //
            // Grow
            //
            alg.ap.swap(ref a, ref olda);
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            // Enough place?
            //
            if( alg.ap.cols(a)>=n && alg.ap.rows(a)>=minrows )
            {
                return;
            }
            ...
            if( alg.ap.cols(a)<n )
            {
                n = Math.Max(n, (int)Math.Round(1.8*alg.ap.cols(a)+1));
            }
            n2 = Math.Min(alg.ap.cols(a), n);
            m = alg.ap.rows(a);
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>=0, "APSERVIsFiniteVector: internal error (N<0)");
            if( n==0 )
            {
                result = true;
                return result;
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>=0, "APSERVIsFiniteCVector: internal error (N<0)");
            for(i=0; i<=n-1; i++)
            {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>=0, "APSERVIsFiniteMatrix: internal error (N<0)");
            alg.ap.assert(m>=0, "APSERVIsFiniteMatrix: internal error (M<0)");
            if( m==0 || n==0 )
            {
                result = true;
                return result;
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>=0, "APSERVIsFiniteCMatrix: internal error (N<0)");
            alg.ap.assert(m>=0, "APSERVIsFiniteCMatrix: internal error (M<0)");
            for(i=0; i<=m-1; i++)
            {
                for(j=0; j<=n-1; j++)
                {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>=0, "APSERVIsFiniteRTRMatrix: internal error (N<0)");
            if( n==0 )
            {
                result = true;
                return result;
            }
            if( alg.ap.rows(x)<n || alg.ap.cols(x)<n )
            {
                result = false;
                return result;
            }
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>=0, "APSERVIsFiniteCTRMatrix: internal error (N<0)");
            for(i=0; i<=n-1; i++)
            {
                if( isupper )
                {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>=0, "APSERVIsFiniteOrNaNMatrix: internal error (N<0)");
            alg.ap.assert(m>=0, "APSERVIsFiniteOrNaNMatrix: internal error (M<0)");
            for(i=0; i<=m-1; i++)
            {
                for(j=0; j<=n-1; j++)
                {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert((double)(a)<(double)(b), "APPeriodicMap: internal error!");
        ...
        Returns random normal number using low-quality system-provided generator
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static double randomnormal(alg.xparams _params)
        {
            double result = 0;
            double u = 0;
            double v = 0;
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "RandomUnit: N<=0");
            if( alg.ap.len(x)<n )
            {
                x = new double[n];
            }
        ...
        *************************************************************************/
        public static void alloccomplex(alg.serializer s,
            complex v,
            alg.xparams _params)
        {
            s.alloc_entry();
        ...
        *************************************************************************/
        public static void serializecomplex(alg.serializer s,
            complex v,
            alg.xparams _params)
        {
        ...
        *************************************************************************/
        public static complex unserializecomplex(alg.serializer s,
            alg.xparams _params)
        {
            complex result = 0;
        ...
        *************************************************************************/
        public static void allocrealarray(alg.serializer s,
            double[] v,
            int n,
            alg.xparams _params)
        {
        ...
        Serialization: complex value
        *************************************************************************/
        public static void serializerealarray(alg.serializer s,
            double[] v,
            int n,
            alg.xparams _params)
        {
        ...
        Unserialization: complex value
        *************************************************************************/
        public static void unserializerealarray(alg.serializer s,
            ref double[] v,
            alg.xparams _params)
        {
            int n = 0;
        ...
        *************************************************************************/
        public static void allocintegerarray(alg.serializer s,
            int[] v,
            int n,
            alg.xparams _params)
        {
        ...
        *************************************************************************/
        public static void serializeintegerarray(alg.serializer s,
            int[] v,
            int n,
            alg.xparams _params)
        {
        ...
        Unserialization: complex value
        *************************************************************************/
        public static void unserializeintegerarray(alg.serializer s,
            ref int[] v,
            alg.xparams _params)
        {
            int n = 0;
        ...
        *************************************************************************/
        public static void allocrealmatrix(alg.serializer s,
            double[,] v,
            int n0,
            int n1,
            alg.xparams _params)
        ...
        Serialization: complex value
        *************************************************************************/
        public static void serializerealmatrix(alg.serializer s,
            double[,] v,
            int n0,
            int n1,
            alg.xparams _params)
        ...
        Unserialization: complex value
        *************************************************************************/
        public static void unserializerealmatrix(alg.serializer s,
            ref double[,] v,
            alg.xparams _params)
        {
            int i = 0;
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            if( alg.ap.len(src)>0 )
            {
                dst = new bool[alg.ap.len(src)];
                for(i=0; i<=alg.ap.len(src)-1; i++)
                {
                    dst[i] = src[i];
                }
            }
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            if( alg.ap.rows(src)>0 && alg.ap.cols(src)>0 )
            {
                dst = new double[alg.ap.rows(src), alg.ap.cols(src)];
                for(i=0; i<=alg.ap.rows(src)-1; i++)
                {
                    for(j=0; j<=alg.ap.cols(src)-1; j++)
                    {
                        dst[i,j] = src[i,j];
                    }
                }
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(tasksize>=2, "TiledSplit: TaskSize<2");
            alg.ap.assert(tasksize>tilesize, "TiledSplit: TaskSize<=TileSize");
            cc = chunkscount(tasksize, tilesize, _params);
            alg.ap.assert(cc>=2, "TiledSplit: integrity check failed");
            task0 = idivup(cc, 2, _params)*tilesize;
            task1 = tasksize-task0;
            alg.ap.assert(task0>=1, "TiledSplit: internal error");
            alg.ap.assert(task1>=1, "TiledSplit: internal error");
            alg.ap.assert(task0%tilesize==0, "TiledSplit: internal error");
            alg.ap.assert(task0>=task1, "TiledSplit: internal error");
        }
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(tasksize>=2, "SplitLengthEven: TaskSize<2");
            if( tasksize==2 )
            {
                task0 = 1;
                task1 = 1;
            ...
            alg.ap.assert(task0>=1, "SplitLengthEven: internal error");
            alg.ap.assert(task1>=1, "SplitLengthEven: internal error");
        }
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(tasksize>=0, "ChunksCount: TaskSize<0");
            alg.ap.assert(chunksize>=1, "ChunksCount: ChunkSize<1");
        ...
        functionality.
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static double sparselevel2density(alg.xparams _params)
        {
            double result = 0;
        ...
        implementation of Level 3 linear algebra.
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static int matrixtilesizea(alg.xparams _params)
        {
            int result = 0;
        ...
        processing by vendor's implementation of Level 3 linear algebra.
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static int matrixtilesizeb(alg.xparams _params)
        {
            int result = 0;
        ...
        *************************************************************************/
        public static double smpactivationlevel(alg.xparams _params)
        {
            double result = 0;
            double nn = 0;
        ...
        It returns real number in order to avoid overflow problems.
          ...
          -- ALGLIB --
             Copyright 10.01.2018 by Bochkanov Sergey
        *************************************************************************/
        public static double spawnlevel(alg.xparams _params)
        {
            double result = 0;
            double nn = 0;
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(chunksize>=2, "SplitLength: ChunkSize<2");
            alg.ap.assert(tasksize>=2, "SplitLength: TaskSize<2");
            task0 = tasksize/2;
            ...
            task1 = tasksize-task0;
            alg.ap.assert(task0>=1, "SplitLength: internal error");
            alg.ap.assert(task1>=1, "SplitLength: internal error");
        }
    ...
    public class tsort
    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            // General case
            //
            if( alg.ap.len(bufa)<n )
            {
                bufa = new double[n];
            }
            if( alg.ap.len(bufb)<n )
            {
                bufb = new int[n];
            }
    ...
    public class ablasf
    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert((double)(alpha)!=(double)(0), "RMatrixGEMMK44V00: internal error (Alpha=0)");
    ...
    public class safesolve
    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "RMatrixTRSafeSolve: incorrect N!");
            alg.ap.assert(trans==0 || trans==1, "RMatrixTRSafeSolve: incorrect Trans!");
            result = true;
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "CMatrixTRSafeSolve: incorrect N!");
            alg.ap.assert((trans==0 || trans==1) || trans==2, "CMatrixTRSafeSolve: incorrect Trans!");
            result = true;
            lnmax = Math.Log(math.maxrealnumber);
    ...
    public class blas
    {
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(i2-i1==j2-j1, "UpperHessenberg1Norm: I2-I1<>J2-J1!");
            for(j=j1; j<=j2; j++)
            {
                work[j] = 0;
            }
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(is2-is1==id2-id1, "CopyMatrix: different sizes!");
            alg.ap.assert(js2-js1==jd2-jd1, "CopyMatrix: different sizes!");
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(i1-i2==j1-j2, "InplaceTranspose error: incorrect array size!");
            for(i=i1; i<=i2-1; i++)
            {
                j = j1+i-i1;
                ips = i+1;
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(is2-is1==jd2-jd1, "CopyAndTranspose: different sizes!");
            alg.ap.assert(js2-js1==id2-id1, "CopyAndTranspose: different sizes!");
            for(isrc=is1; isrc<=is2; isrc++)
            {
                jdst = isrc-is1+jd1;
                i1_ = (js1) - (id1);
            ...
            alg.xparams _params)
        {
            ...
            if( !trans )
            {
                ...
                alg.ap.assert(j2-j1==ix2-ix1, "MatrixVectorMultiply: A and X dont match!");
                alg.ap.assert(i2-i1==iy2-iy1, "MatrixVectorMultiply: A and Y dont match!");
            ...
            else
            {
                ...
                alg.ap.assert(i2-i1==ix2-ix1, "MatrixVectorMultiply: A and X dont match!");
                alg.ap.assert(j2-j1==iy2-iy1, "MatrixVectorMultiply: A and Y dont match!");
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(acols==brows, "MatrixMatrixMultiply: incorrect matrix sizes!");
    ...
    public class linmin
    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            if( alg.ap.len(state.x)<n )
            {
                state.x = new double[n];
            }
            if( alg.ap.len(state.xbase)<n )
            {
                state.xbase = new double[n];
            }
            if( alg.ap.len(state.s)<n )
            {
    ...
    public class xblas
    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n<536870912, "XDot: N is too large!");
    ...
    public class basicstatops
    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            if( alg.ap.len(buf.ra1)<n )
            {
                buf.ra1 = new double[n];
            }
            if( alg.ap.len(buf.ia1)<n )
            {
                buf.ia1 = new int[n];
            }
            for(i=0; i<=n-1; i++)
    ...
    public class hpccores
    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            if( alg.ap.rows(buf.xy)<chunksize || alg.ap.cols(buf.xy)<nin+nout )
            {
                buf.xy = new double[chunksize, nin+nout];
            }
            if( alg.ap.rows(buf.xy2)<chunksize || alg.ap.cols(buf.xy2)<nin+nout )
            {
                buf.xy2 = new double[chunksize, nin+nout];
            }
            if( alg.ap.len(buf.xyrow)<nin+nout )
            {
                buf.xyrow = new double[nin+nout];
            }
            if( alg.ap.len(buf.x)<nin )
            {
                buf.x = new double[nin];
            }
            if( alg.ap.len(buf.y)<nout )
            {
                buf.y = new double[nout];
            }
            if( alg.ap.len(buf.desiredy)<nout )
            {
                buf.desiredy = new double[nout];
            }
            if( alg.ap.len(buf.batch4buf)<batch4size )
            {
                buf.batch4buf = new double[batch4size];
            }
            if( alg.ap.len(buf.hpcbuf)<wcount )
            {
                buf.hpcbuf = new double[wcount];
            }
            if( alg.ap.len(buf.g)<wcount )
            {
    ...
    public class ntheory
    {
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>=3, "FindPrimitiveRootAndInverse: N<3");
            proot = 0;
            invproot = 0;
            ...
            //
            alg.ap.assert(isprime(n, _params), "FindPrimitiveRoot: N is not prime");
            ...
            alg.ap.assert(proot>=2, "FindPrimitiveRoot: internal error (root not found)");
            ...
            //
            n2 = (n-1)*(n-1);
            alg.ap.assert(n2/(n-1)==n-1, "FindPrimitiveRoot: internal error");
            alg.ap.assert(proot*invproot/proot==invproot, "FindPrimitiveRoot: internal error");
            alg.ap.assert(proot*invproot/invproot==proot, "FindPrimitiveRoot: internal error");
            alg.ap.assert(proot*invproot%n==1, "FindPrimitiveRoot: internal error");
        }
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(a>=0 && a<n, "ModMul: A<0 or A>=N");
            alg.ap.assert(b>=0 && b<n, "ModMul: B<0 or B>=N");
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(a>=0 && a<n, "ModExp: A<0 or A>=N");
            alg.ap.assert(b>=0, "ModExp: B<0");
    ...
    public class ftbase
    {
        ...
        *************************************************************************/
        public class fasttransformplan : apobject
        {
            ...
            public double[] precr;
            public double[] preci;
            public alg.smp.shared_pool bluesteinpool;
            ...
            public override void init()
            {
                ...
                precr = new double[0];
                preci = new double[0];
                bluesteinpool = new alg.smp.shared_pool();
            }
            public override alg.apobject make_copy()
            {
                ...
                _result.bluesteinpool = (alg.smp.shared_pool)bluesteinpool.make_copy();
                return _result;
            }
        };
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            //
            alg.ap.assert(n>0, "FTComplexFFTPlan: N<=0");
            alg.ap.assert(k>0, "FTComplexFFTPlan: K<=0");
            ...
            alg.smp.ae_shared_pool_set_seed(plan.bluesteinpool, bluesteinbuf);
            ...
            //
            alg.ap.assert(precrptr==precrsize, "FTComplexFFTPlan: internal error (PrecRPtr<>PrecRSize)");
            alg.ap.assert(preciptr==precisize, "FTComplexFFTPlan: internal error (PrecRPtr<>PrecRSize)");
        }
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "FTComplexFFTPlan: N<=0");
            alg.ap.assert(k>0, "FTComplexFFTPlan: K<=0");
            alg.ap.assert(!topmostplan || childplan, "FTComplexFFTPlan: ChildPlan is inconsistent with TopmostPlan");
        ...
        *************************************************************************/
        private static void ftpushentry2(fasttransformplan plan,
            ...
            alg.xparams _params)
        {
            if( rowptr>=alg.ap.rows(plan.entries) )
            {
                apserv.imatrixresize(ref plan.entries, Math.Max(2*alg.ap.rows(plan.entries), 1), colscnt, _params);
            }
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(plan.entries[subplan,coltype]==opstart, "FTApplySubPlan: incorrect subplan header");
            rowidx = subplan+1;
            while( plan.entries[rowidx,coltype]!=opend )
            {
                ...
                if( operation==opparallelcall )
                {
                    ...
                    alg.ap.assert(plan.entries[rowidx+param0,coltype]==opstart, "FTApplySubPlan: incorrect child subplan header");
                    alg.ap.assert(parentsize==childsize, "FTApplySubPlan: incorrect child subplan header");
                ...
                {
                    alg.ap.assert(microvectorsize==2, "FTApplySubPlan: microvectorsize!=2 for Bluesteins FFT");
                    alg.smp.ae_shared_pool_retrieve(plan.bluesteinpool, ref bufa);
                    alg.smp.ae_shared_pool_retrieve(plan.bluesteinpool, ref bufb);
                    alg.smp.ae_shared_pool_retrieve(plan.bluesteinpool, ref bufc);
                    alg.smp.ae_shared_pool_retrieve(plan.bluesteinpool, ref bufd);
                    ...
                    alg.smp.ae_shared_pool_recycle(plan.bluesteinpool, ref bufa);
                    alg.smp.ae_shared_pool_recycle(plan.bluesteinpool, ref bufb);
                    alg.smp.ae_shared_pool_recycle(plan.bluesteinpool, ref bufc);
                    alg.smp.ae_shared_pool_recycle(plan.bluesteinpool, ref bufd);
                    rowidx = rowidx+1;
                    continue;
                }
                ...
                {
                    alg.ap.assert(microvectorsize==2, "FTApplySubPlan: MicrovectorSize<>1");
                ...
                // Error
                //
                alg.ap.assert(false, "FTApplySubPlan: unexpected plan type");
            }
        }
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(operandscnt>=1, "FTApplyComplexRefFFT: OperandsCnt<1");
            alg.ap.assert(operandsize>=1, "FTApplyComplexRefFFT: OperandSize<1");
            alg.ap.assert(microvectorsize==2, "FTApplyComplexRefFFT: MicrovectorSize<>2");
            n = operandsize;
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(operandscnt>=1, "FTApplyComplexCodeletFFT: OperandsCnt<1");
            alg.ap.assert(operandsize>=1, "FTApplyComplexCodeletFFT: OperandSize<1");
            alg.ap.assert(microvectorsize==2, "FTApplyComplexCodeletFFT: MicrovectorSize<>2");
            n = operandsize;
            
            //
            // Hard-coded transforms for different N's
            //
            alg.ap.assert(n<=maxradix, "FTApplyComplexCodeletFFT: N>MaxRadix");
            if( n==2 )
            {
                for(opidx=0; opidx<=operandscnt-1; opidx++)
                {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(operandscnt>=1, "FTApplyComplexCodeletFFT: OperandsCnt<1");
            alg.ap.assert(operandsize>=1, "FTApplyComplexCodeletFFT: OperandSize<1");
            alg.ap.assert(microvectorsize>=1, "FTApplyComplexCodeletFFT: MicrovectorSize<>1");
            alg.ap.assert(microvectorsize%2==0, "FTApplyComplexCodeletFFT: MicrovectorSize is not even");
            n = operandsize;
            m = microvectorsize/2;
            ...
            // Hard-coded transforms for different N's
            //
            alg.ap.assert(n<=maxradix, "FTApplyComplexCodeletTwFFT: N>MaxRadix");
            if( n==2 )
            {
                v = -(2*Math.PI/(n*m));
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "FTFactorize: N<=0");
            n1 = 0;
            n2 = 0;
            ...
            if( n>recursivethreshold )
            {
                ...
                alg.ap.assert(k*k>=n, "FTFactorize: internal error during recursive factorization");
                for(j=k; j>=2; j--)
                {
                    if( n%j==0 )
                    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "FTOptimisticEstimate: N<=0");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            //
            //
            alg.ap.assert(updatetw>=2, "FFTTwCalc: internal error - UpdateTw<2");
        ...
        *************************************************************************/
        private static void ftbasefindsmoothrec(int n,
            ...
            alg.xparams _params)
        {
            alg.ap.assert(ftbasemaxsmoothfactor<=5, "FTBaseFindSmoothRec: internal error!");
            if( seed>=n )
            {
