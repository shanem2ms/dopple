...
public partial class alg
{
    ...
    *************************************************************************/
    ...
    public static void fftc1d(ref complex[] a, int n, alg.xparams _params)
    {
    ...
    public static void fftc1d(ref complex[] a, alg.xparams _params)
    {
        int n;
    ...
    *************************************************************************/
    ...
    public static void fftc1dinv(ref complex[] a, int n, alg.xparams _params)
    {
    ...
    public static void fftc1dinv(ref complex[] a, alg.xparams _params)
    {
        int n;
    ...
    *************************************************************************/
    ...
    public static void fftr1d(double[] a, int n, out complex[] f, alg.xparams _params)
    {
        f = new complex[0];
    ...
    public static void fftr1d(double[] a, out complex[] f, alg.xparams _params)
    {
        int n;
    ...
    *************************************************************************/
    ...
    public static void fftr1dinv(complex[] f, int n, out double[] a, alg.xparams _params)
    {
        a = new double[0];
    ...
    public static void fftr1dinv(complex[] f, out double[] a, alg.xparams _params)
    {
        int n;
...
public partial class alg
{
    ...
    *************************************************************************/
    ...
    public static void fhtr1d(ref double[] a, int n, alg.xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void fhtr1dinv(ref double[] a, int n, alg.xparams _params)
    {
...
public partial class alg
{
    ...
    *************************************************************************/
    ...
    public static void convc1d(complex[] a, int m, complex[] b, int n, out complex[] r, alg.xparams _params)
    {
        r = new complex[0];
    ...
    *************************************************************************/
    ...
    public static void convc1dinv(complex[] a, int m, complex[] b, int n, out complex[] r, alg.xparams _params)
    {
        r = new complex[0];
    ...
    *************************************************************************/
    ...
    public static void convc1dcircular(complex[] s, int m, complex[] r, int n, out complex[] c, alg.xparams _params)
    {
        c = new complex[0];
    ...
    *************************************************************************/
    ...
    public static void convc1dcircularinv(complex[] a, int m, complex[] b, int n, out complex[] r, alg.xparams _params)
    {
        r = new complex[0];
    ...
    *************************************************************************/
    ...
    public static void convr1d(double[] a, int m, double[] b, int n, out double[] r, alg.xparams _params)
    {
        r = new double[0];
    ...
    *************************************************************************/
    ...
    public static void convr1dinv(double[] a, int m, double[] b, int n, out double[] r, alg.xparams _params)
    {
        r = new double[0];
    ...
    *************************************************************************/
    ...
    public static void convr1dcircular(double[] s, int m, double[] r, int n, out double[] c, alg.xparams _params)
    {
        c = new double[0];
    ...
    *************************************************************************/
    ...
    public static void convr1dcircularinv(double[] a, int m, double[] b, int n, out double[] r, alg.xparams _params)
    {
        r = new double[0];
...
public partial class alg
{
    ...
    *************************************************************************/
    ...
    public static void corrc1d(complex[] signal, int n, complex[] pattern, int m, out complex[] r, alg.xparams _params)
    {
        r = new complex[0];
    ...
    *************************************************************************/
    ...
    public static void corrc1dcircular(complex[] signal, int m, complex[] pattern, int n, out complex[] c, alg.xparams _params)
    {
        c = new complex[0];
    ...
    *************************************************************************/
    ...
    public static void corrr1d(double[] signal, int n, double[] pattern, int m, out double[] r, alg.xparams _params)
    {
        r = new double[0];
    ...
    *************************************************************************/
    ...
    public static void corrr1dcircular(double[] signal, int m, double[] pattern, int n, out double[] c, alg.xparams _params)
    {
        c = new double[0];
    ...
    public class fft
    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "FFTC1D: incorrect N!");
            alg.ap.assert(alg.ap.len(a)>=n, "FFTC1D: Length(A)<N!");
            alg.ap.assert(apserv.isfinitecvector(a, n, _params), "FFTC1D: A contains infinite or NAN values!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "FFTC1DInv: incorrect N!");
            alg.ap.assert(alg.ap.len(a)>=n, "FFTC1DInv: Length(A)<N!");
            alg.ap.assert(apserv.isfinitecvector(a, n, _params), "FFTC1DInv: A contains infinite or NAN values!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "FFTR1D: incorrect N!");
            alg.ap.assert(alg.ap.len(a)>=n, "FFTR1D: Length(A)<N!");
            alg.ap.assert(apserv.isfinitevector(a, n, _params), "FFTR1D: A contains infinite or NAN values!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "FFTR1DInv: incorrect N!");
            alg.ap.assert(alg.ap.len(f)>=(int)Math.Floor((double)n/(double)2)+1, "FFTR1DInv: Length(F)<Floor(N/2)+1!");
            alg.ap.assert(math.isfinite(f[0].x), "FFTR1DInv: F contains infinite or NAN values!");
            for(i=1; i<=(int)Math.Floor((double)n/(double)2)-1; i++)
            {
                alg.ap.assert(math.isfinite(f[i].x) && math.isfinite(f[i].y), "FFTR1DInv: F contains infinite or NAN values!");
            }
            alg.ap.assert(math.isfinite(f[(int)Math.Floor((double)n/(double)2)].x), "FFTR1DInv: F contains infinite or NAN values!");
            if( n%2!=0 )
            {
                alg.ap.assert(math.isfinite(f[(int)Math.Floor((double)n/(double)2)].y), "FFTR1DInv: F contains infinite or NAN values!");
            }
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0 && n%2==0, "FFTR1DEvenInplace: incorrect N!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0 && n%2==0, "FFTR1DInvInternalEven: incorrect N!");
    ...
    public class fht
    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "FHTR1D: incorrect N!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0, "FHTR1DInv: incorrect N!");
    ...
    public class conv
    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0 && m>0, "ConvC1D: incorrect N or M!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert((n>0 && m>0) && n<=m, "ConvC1DInv: incorrect N or M!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0 && m>0, "ConvC1DCircular: incorrect N or M!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0 && m>0, "ConvC1DCircularInv: incorrect N or M!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0 && m>0, "ConvR1D: incorrect N or M!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert((n>0 && m>0) && n<=m, "ConvR1DInv: incorrect N or M!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0 && m>0, "ConvR1DCircularInv: incorrect N or M!");
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0 && m>0, "ConvC1DX: incorrect N or M!");
            alg.ap.assert(n<=m, "ConvC1DX: N<M assumption is false!");
            ...
            if(ialg == -1 || ialg == -2 )
            {
                ...
                ialg = algbest;
                convc1dx(a, m, b, n, circular, ialg, q, ref r, _params);
                return;
            }
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            if(ialg < 0 )
            {
                ...
                ialg = algbest;
                convr1dx(a, m, b, n, circular, ialg, q, ref r, _params);
                return;
            }
            ...
            if(ialg == 1 )
            {
                alg.ap.assert(m+n-1>2, "ConvR1DX: internal error!");
                if( (circular && ftbase.ftbaseissmooth(m, _params)) && m%2==0 )
                {
            ...
            if(ialg == 2 )
            {
                alg.ap.assert((q+n-1)%2==0, "ConvR1DX: internal error!");
    ...
    public class corr
    {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0 && m>0, "CorrC1D: incorrect N or M!");
            p = new complex[m];
            for(i=0; i<=m-1; i++)
            {
        ...
        *************************************************************************/
            ...
            alg.xparams _params)
        {
            ...
            alg.ap.assert(n>0 && m>0, "CorrR1D: incorrect N or M!");
            p = new double[m];
            for(i=0; i<=m-1; i++)
            {
                p[m-1-i] = pattern[i];
