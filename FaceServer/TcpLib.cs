...
namespace TcpLib
{
    ...
    public class TcpServer
    {
        ...
        public static string GetLocalIPAddress()
        {
            ...
            NetworkInterface niWithGateway = NetworkInterface
               .GetAllNetworkInterfaces()
               .Where(n => n.OperationalStatus == OperationalStatus.Up)
               .Where(n => n.NetworkInterfaceType != NetworkInterfaceType.Loopback)
               .Where(n => n.GetIPProperties()?.GatewayAddresses.Select(g => g.Address != null).Count() > 0)
               .FirstOrDefault();

            var ipAddr = niWithGateway.GetIPProperties().UnicastAddresses.Where
                (a => a.Address.AddressFamily == AddressFamily.InterNetwork).First();
        ...
        public bool Start()
        {
            try
            {
                ...
                _listener.Bind(new IPEndPoint(IPAddress.Parse(ipAddress), _port));
